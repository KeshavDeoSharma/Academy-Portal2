				...
				<div class="col-sm-6">
					 <div class="card">
					  <div class="card-body">
						...
						<spring:url value="/addfaculty" var="url" htmlEscape="true" />
						<a href="${url}" class="btn btn-primary color-b">Register</a>
					...
					<div class="card">
					  <div class="card-body">
						...
						<p class="card-text">Add Modules for the academy</p>
							<spring:url value="/module" var="url1" htmlEscape="true" />
						<a href="${url1 }" class="btn btn-primary color-b">Add</a>
				...
				<div class="col-sm-6">
					<div class="card">
					  <div class="card-body">
						...
						<spring:url value="/BatchAllocation" var="url3" htmlEscape="true"/>
						<a href="${url3}" class="btn btn-primary btn-sm color-b">Allocate</a>
						<spring:url value="/BatchUpdation" var="url2" htmlEscape="true"/>
						<a href="${url2 }" class="btn btn-primary btn-sm color-b">Update</a>
					  </div>
					</div>
				</div>
				<div class="col-sm-6">
